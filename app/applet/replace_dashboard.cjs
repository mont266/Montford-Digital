                    ...
                    <div className="flex flex-col gap-6">
                      ...
                      <div className="bg-slate-800 rounded-xl border border-slate-700 p-6 md:p-8 shadow-xl relative overflow-hidden">
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mt-2 relative z-10">
                          <div>
                            ...
                            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white tracking-tight">{project.name}</h2>
                          </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-6">
                           ...
                           {/* Task Board */}
                           <div className="bg-slate-800 rounded-xl border border-slate-700 p-5 shadow-lg flex flex-col flex-1 h-[400px]">
