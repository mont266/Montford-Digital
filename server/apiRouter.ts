...
jsonRouter.post('/create-payment-intent', async (req, res) => {
  try {
...
jsonRouter.post('/create-subscription', async (req, res) => {
  try {
...
jsonRouter.get('/subscription/:id', async (req, res) => {
  try {
    const stripe = getStripe();
...
jsonRouter.post('/cancel-subscription', async (req, res) => {
  try {
